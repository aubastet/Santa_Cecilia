  ...
  <div class="container_col_section">
    <div class="container_col_section_">
      <div class="container_col_01">
        <div class="container_col_text_1">
          <h2 class="h1_col_02">IT'S A MORE SUSTAINABLE CHOICE THAT'S BUILT TO LAST.</h2> <br>
    ...
    <div class="container_col_section_">
      ...
      <div class="container_col_01">
        ...
        <div class="container_col_text_2">
          <p class="h1_col_02">Founded in colombia, medellin with the ambition</h1>
        </div>
      </div>
    </div>
  </div>
